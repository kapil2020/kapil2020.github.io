      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-air-quality-dashboard",
          title: 'Air Quality Dashboard',
          description: "An interactive dashboard for exploring urban air quality and pollutant concentrations.",
          section: "Projects",handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-maas-demand-study",
          title: 'MaaS Demand Study',
          description: "Exploring factors influencing Mobility-as-a-Service adoption and demand using discrete choice models and survey data.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/maas-demand-study/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6B%61%70%69%6C%6D.%34%38@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/kapil2020", "_blank");
        },
      },{
        id: 'social-instagram',
        title: 'Instagram',
        section: 'Socials',
        handler: () => {
          window.open("https://instagram.com/roger.me__", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/kapilmeena", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0002-0271-0175", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.researchgate.net/profile/https://www.researchgate.net/profile/Kapil-Meena-3?ev=hdr_xprf/", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=5jIAPTEAAAAJ", "_blank");
        },
      },{
        id: 'social-scopus',
        title: 'Scopus',
        section: 'Socials',
        handler: () => {
          window.open("https://www.scopus.com/authid/detail.uri?authorId=57191300782", "_blank");
        },
      },{
        id: 'social-work',
        title: 'Work',
        section: 'Socials',
        handler: () => {
          window.open("https://www.mustlab.in/", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/kapil__iitr", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://sites.google.com/view/kapil-lab/home", "_blank");
        },
      },{
      id: 'light-theme',
